...
[[nodiscard]] uint64_t SelectionKey(const RogueCity::Core::Editor::SelectionItem& item);
...
[[nodiscard]] bool ResolveSelectionAnchor(
...
[[nodiscard]] RogueCity::Core::Vec2 ComputeSelectionPivot(const RogueCity::Core::Editor::GlobalState& gs);
...
[[nodiscard]] uint32_t NextLotId(const RogueCity::Core::Editor::GlobalState& gs);
[[nodiscard]] uint32_t NextBuildingId(const RogueCity::Core::Editor::GlobalState& gs);
[[nodiscard]] uint32_t NextWaterId(const RogueCity::Core::Editor::GlobalState& gs);

[[nodiscard]] std::vector<RogueCity::Core::Vec2> MakeSquareBoundary(
...
[[nodiscard]] bool SimplifyPolyline(std::vector<RogueCity::Core::Vec2>& points, bool closed);
