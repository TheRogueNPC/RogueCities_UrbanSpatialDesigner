// FILE: IPanelDrawer.h
// PURPOSE: Core interface for panel content drawers in Master Panel
// architecture PATTERN: Registry-based panel routing with state-reactive
// visibility
...
enum class PanelType : uint8_t {
  ...
  RiverIndex,
  BuildingIndex,
  GuideIndex, // Divider guide index panel
