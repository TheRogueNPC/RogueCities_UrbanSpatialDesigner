...
PanelRegistry::GetPanelsInCategory(PanelCategory cat) const {
...
void PanelRegistry::Clear() { m_drawers.clear(); }
...
void InitializePanelRegistry() {
  ...
  registry.Register(
      std::unique_ptr<IPanelDrawer>(DistrictIndex::CreateDrawer()));
  ...
  registry.Register(
      std::unique_ptr<IPanelDrawer>(BuildingIndex::CreateDrawer()));

  // Register Controls
  registry.Register(
      std::unique_ptr<IPanelDrawer>(ZoningControl::CreateDrawer()));
