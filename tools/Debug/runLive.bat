@echo off
REM Run RogueCity toolserver in LIVE mode (with Ollama AI)
REM Requires: Ollama running on localhost:11434

setlocal

echo ========================================
echo  RogueCity AI Toolserver - LIVE MODE
echo ========================================
echo.

REM Clear mock mode environment variable
set ROGUECITY_TOOLSERVER_MOCK=

echo Starting toolserver with real AI (Ollama)...
echo Endpoints available:
echo   GET  http://127.0.0.1:7077/health
echo   POST http://127.0.0.1:7077/ui_agent
echo   POST http://127.0.0.1:7077/city_spec
echo   POST http://127.0.0.1:7077/ui_design_assistant
echo.
...
if %ERRORLEVEL% NEQ 0 (
    echo ✗ ERROR: Ollama not detected at http://127.0.0.1:11434
    echo.
